  ...
  return (
    <main className="bg-page min-h-screen selection:bg-brand-blue/30 selection:text-white">
      ...
      <div className="space-y-0">
        ...
        <section id="expertise" className="scroll-mt-32 relative overflow-hidden bg-section-tinted">
        ...
        <section id="projects" className="scroll-mt-32 relative overflow-hidden bg-section-tinted">
