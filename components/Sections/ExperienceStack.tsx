                ...
                {experiences.map((role, idx) => (
                    <div key={idx} className="group relative grid grid-cols-1 md:grid-cols-12 gap-8 border-t border-border pt-12 hover:border-brand-blue/30 transition-colors duration-500">
                        ...
                        <div className="md:col-span-3">
                            <span className="text-display text-5xl md:text-6xl text-silver/20 group-hover:text-silver/60 transition-colors duration-500">
                        ...
                        <div className="md:col-span-9 space-y-8">
                            <div className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-2">
                                <h3 className="text-3xl md:text-4xl font-display font-medium text-silver group-hover:text-brand-blue transition-colors duration-300">
                                    {role.company}
                                </h3>
                                    ...
                                    <div key={pIdx} className="relative pl-6 border-l border-border group-hover/pos:border-brand-purple/50 transition-colors">
                                        ...
                                        <ul className="space-y-2">
                                            {pos.achievements.map((item, i) => (
                                                <li key={i} className="text-muted dark:text-gray-400 text-sm leading-relaxed max-w-3xl flex items-start gap-2">
